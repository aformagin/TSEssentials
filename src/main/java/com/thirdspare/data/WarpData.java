...
/**
 * Data model for warp locations
 * Warps are server-wide teleport points that can be accessed by all players
 */
public class WarpData {
    ...
    public WarpData(String worldUUID, double x, double y, double z, float pitch, float yaw, float roll) {
    ...
    /**
     * Codec for serializing/deserializing WarpData to JSON
     */
    public static final BuilderCodec<WarpData> CODEC = BuilderCodec.builder(WarpData.class, WarpData::new)
