...
/**
 * Represents a player's home location data for codec-based serialization
 */
public class PlayerHomeData {
    ...
    public PlayerHomeData(String worldUUID, double x, double y, double z,
    ...
    /**
     * Codec for serializing/deserializing PlayerHomeData
     */
    public static final BuilderCodec<PlayerHomeData> CODEC = BuilderCodec.builder(PlayerHomeData.class, PlayerHomeData::new)
